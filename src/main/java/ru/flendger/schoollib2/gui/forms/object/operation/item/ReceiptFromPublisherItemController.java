...
@Scope("prototype")
@NoArgsConstructor
public class ReceiptFromPublisherItemController extends AbstractOperationItemController<ReceiptFromPublisherItem, BorderPane> implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        title = "Строка операции: Поступление от издательства";
